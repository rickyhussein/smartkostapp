...
@section('container')
    <div id="app-wrap" class="style1">
        <div class="tf-container">
            <form action="{{ url('/rent/user') }}" class="mt-4">
                <div class="row">
                    <div class="col-10">
            ...
            @else
                @foreach ($rents as $rent)
                    <div class="mt-4">
                        <a href="{{ url('/rent/user/show/'.$rent->id) }}">
                            <div class="card text-dark bg-light mb-3" style="border-radius: 15px;">
                                <div class="card-body">
                                    ...
                                    <div class="col-8">
                                        ...
                                        @if ($rent->transaction($rent->id))
                                            <div class="badge me-1" style="color: rgb(255, 135, 36); border:1px solid rgb(255, 135, 36); background-color:rgba(255, 233, 197, 0.889); border-radius:5x;">{{ $rent->transaction($rent->id)->status ?? '-' }}</div>
                                        @endif
                                    </div>
                                </div>
                            </div>
