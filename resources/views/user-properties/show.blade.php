        ...
        <div class="bill-content">
            ...
            <div class="app-section bg_white_color giftcard-detail-section-1">
                <div class="tf-container">
                    ...
                    <hr style="color: rgb(30, 30, 30)">
                    <div class="voucher-desc">
                        <h4 class="fw_6" style="float: left">Complain</h4>
                        <div class="badge" style="color: rgb(21, 47, 118); border:1px solid rgb(21, 47, 118); background-color:rgba(210, 229, 255, 0.889); border-radius:5x; float: right;">+ Tambah</div>
                        <br>
                        <br>
