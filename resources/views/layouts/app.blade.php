        ...
        <div class="app-header">
            <div class="tf-container">
                <div class="tf-topbar d-flex justify-content-between align-items-center">
                    <a class="user-info d-flex justify-content-between align-items-center" href="{{ auth()->user() ? url('/profile/user') : url('/login') }}">
                    ...
                    <div class="d-flex align-items-center gap-4">
                        ...
                        <a href="{{ auth()->user() ? url('/notifications/user') : url('/login') }}" class="icon-notification1">
    ...
    <div class="bottom-navigation-bar">
        <div class="tf-container">
            <ul class="tf-navigation-bar">
                ...
                <li class="{{ Request::is('properties-user*') ? 'active' : '' }}">
                    <a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="{{ auth()->user() ? url('/properties-user') : url('/login') }}">
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="width: 28px;" viewBox="0 0 122.879 110.328" enable-background="new 0 0 122.879 110.328" xml:space="preserve">
                            <g fill="#{{ Request::is('properties-user*') ? '0000FF' : '000000' }}">
                        ...
                        <span style="color:#{{ Request::is('properties-user*') ? '0000FF' : '000000' }}" class="ms-2">Properti</span>
                    </a>
                </li>

                <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="{{ auth()->user() ? url('/rent-user') : url('/login') }}"><i class="icon-scan-qr-code"></i> </a> </li>

                <li class="{{ Request::is('history-user*') ? 'active' : '' }}">
                    <a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="{{ auth()->user() ? url('/history-user') : url('/login') }}">
                ...
                <li class="{{ Request::is('profile/user*') ? 'active' : '' }}"><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="{{ auth()->user() ? url('/profile/user') : url('/login') }}"><i class="icon-user-outline"></i> Profile</a> </li>
            </ul>
        </div>
    </div>
            ...
            <div class="panel-body">
                <div class="tf-container">
                    <div class="box-content">
                        ...
                        <ul class="box-nav">
                            <li>
                                <a href="{{ auth()->user() ? url('/dashboard/user') : url('/') }}" class="nav-link" >
                                    <span style="{{ Request::is('dashboard/user*') ? 'color: blue' : '' }}">Home</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ auth()->user() ? url('/profile/user') : url('/login') }}" class="nav-link">
                                    <span style="{{ Request::is('profile/user*') ? 'color: blue' : '' }}">Profile</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ auth()->user() ? url('/password/user/edit') : url('/login') }}" class="nav-link">
                                    <span style="{{ Request::is('password/user/edit*') ? 'color: blue' : '' }}">Ganti Password</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ auth()->user() ? url('/notifications/user') : url('/login') }}" class="nav-link">
                                    <span style="{{ Request::is('notifications/user*') ? 'color: blue' : '' }}">Notifications</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ auth()->user() ? url('/logout') : url('/login') }}" class="nav-link" onclick="return confirm('Are You Sure?')">
