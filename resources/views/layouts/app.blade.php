        ...
        <div class="tf-container">
            <ul class="tf-navigation-bar">
                ...
                <li class="{{ Request::is('rent/user*') ? 'active' : '' }}">
                    <a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="{{ url('/rent/user') }}">
