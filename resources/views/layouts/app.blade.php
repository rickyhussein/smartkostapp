        ...
        <div class="tf-container">
            <ul class="tf-navigation-bar">
                ...
                <li class="{{ Request::is('properties/user*') ? 'active' : '' }}">
                    <a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="{{ url('/properties/user') }}">
                ...
                <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="{{ url('/rent/user') }}"><i class="icon-scan-qr-code"></i> </a> </li>
