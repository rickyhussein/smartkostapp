        ...
        <div class="app-header">
            <div class="tf-container">
                <div class="tf-topbar d-flex justify-content-between align-items-center">
                    <a class="user-info d-flex justify-content-between align-items-center" href="{{ url('/profile/user') }}">
                        ...
                        <div class="content">
                            <h4 class="white_color">{{ auth()->user() ? auth()->user()->name : '-' }}</h4>
                            <p class="white_color fw_4">{{ auth()->user() ? auth()->user()->email : '-' }}</p>
                        </div>
                    </a>
                    <div class="d-flex align-items-center gap-4">
                        ...
                        <a href="{{ url('/notifications/user') }}" class="icon-notification1">
    ...
    <div class="bottom-navigation-bar">
        <div class="tf-container">
            <ul class="tf-navigation-bar">
                <li class="{{ Request::is('dashboard/user*') || Request::is('/') ? 'active' : '' }} mt-1">
                    <a class="fw_6 d-flex justify-content-center align-items-center flex-column" href="{{ auth()->user() ? url('/dashboard/user') : url('/') }}">
                        <svg fill="#{{ Request::is('dashboard/user*') || Request::is('/') ? '0000FF' : '000000' }}" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        <span style="color:#{{ Request::is('dashboard/user*') || Request::is('/') ? '0000FF' : '000000' }}">Home</span>
                    </a>
                </li>

                <li class="{{ Request::is('rent/user*') ? 'active' : '' }}">
                    <a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="{{ url('/rents/user') }}">
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="width: 28px;" viewBox="0 0 122.879 110.328" enable-background="new 0 0 122.879 110.328" xml:space="preserve">
                            <g fill="#{{ Request::is('rent/user*') ? '0000FF' : '000000' }}">
                ...
                <li class="{{ Request::is('profile/user*') ? 'active' : '' }}"><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="{{ url('/profile/user') }}"><i class="icon-user-outline"></i> Profile</a> </li>
            </ul>
        </div>
    </div>
                ...
                <div class="tf-container">
                    <div class="box-content">
                        ...
                        <ul class="box-nav">
                            ...
                            <li>
                                <a href="{{ url('/profile/user') }}" class="nav-link">
                                    <span style="{{ Request::is('profile/user*') ? 'color: blue' : '' }}">Profile</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/password/user/edit') }}" class="nav-link">
                                    <span style="{{ Request::is('password/user/edit*') ? 'color: blue' : '' }}">Ganti Password</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('/notifications/user') }}" class="nav-link">
                                    <span style="{{ Request::is('notifications/user*') ? 'color: blue' : '' }}">Notifications</span>
                                </a>
                            </li>
                            <li>
                                @if (auth()->user())
