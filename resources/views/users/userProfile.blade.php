...
@endsection
@section('container')
    <form class="tf-form" action="{{ url('/profile/user/update/'.$user->id) }}" enctype="multipart/form-data" method="POST">
        @method('PUT')
        @csrf
                ...
                <div class="tf-container ms-4 me-4">
                    <div class="card-secton transfer-section mt-2">
                        ...
                        <div class="group-input">
                            ...
                            <select style="width: 100%" name="gender" id="gender" class="select2 @error('gender') is-invalid @enderror">
                                <option value="">-- Pilih Jenis Kelamin --</option>
                                <option value="Laki - laki" {{ 'Laki - laki' == old('gender', $user->gender) ? 'selected="selected"' : '' }}>Laki - laki</option>
                                <option value="Perempuan" {{ 'Perempuan' == old('gender', $user->gender) ? 'selected="selected"' : '' }}>Perempuan</option>
                            </select>
                            @error('gender')
                            <div class="invalid-feedback">
                                {{ $message }}
                        ...
                        <div class="group-input">
                            ...
                            <input type="text" class="date @error('born_date') is-invalid @enderror" id="born_date" name="born_date" value="{{ old('born_date', $user->born_date) }}">
                            @error('born_date')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="group-input">
                            <label for="job" style="z-index: 1000;">Pekerjaan</label>
                            <select style="width: 100%" name="job" id="job" class="select2 @error('job') is-invalid @enderror" data-live-search="true">
                                <option value="">-- Pilih Pekerjaan --</option>
                                <option value="Mahasiswa" {{ 'Mahasiswa' == old('job', $user->job) ? 'selected="selected"' : '' }}>Mahasiswa</option>
                                <option value="Karyawan" {{ 'Karyawan' == old('job', $user->job) ? 'selected="selected"' : '' }}>Karyawan</option>
                            </select>
                            @error('job')
                            <div class="invalid-feedback">
                                {{ $message }}
                        ...
                        <div class="group-input">
                            <label for="job_desc">Nama Kampus / Kantor</label>
                            <input type="text" class="@error('job_desc') is-invalid @enderror" id="job_desc" name="job_desc" value="{{ old('job_desc', $user->job_desc) }}">
                            @error('job_desc')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="group-input">
                            ...
                            <select style="width: 100%;" name="status" id="status" class="select2 @error('status') is-invalid @enderror">
                                ...
                                <option value="Belum Kawin" {{ 'Belum Kawin' == old('status', $user->status) ? 'selected="selected"' : '' }}>Belum Kawin</option>
                                <option value="Kawin" {{ 'Kawin' == old('status', $user->status) ? 'selected="selected"' : '' }}>Kawin</option>
                                <option value="Kawin Memiliki Anak" {{ 'Kawin Memiliki Anak' == old('status', $user->status) ? 'selected="selected"' : '' }}>Kawin Memiliki Anak</option>
                            </select>
                            @error('status')
                            <div class="invalid-feedback">
                                {{ $message }}
                        ...
                        <div class="group-input">
                            <label style="z-index: 1000;" for="last_education">Pendidikan Terkahir</label>
                            <select style="width: 100%;" name="last_education" id="last_education" class="select2 @error('last_education') is-invalid @enderror">
                                <option value="">-- Pilih Pendidikan Terkahir --</option>
                                <option value="SD / MI" {{ 'SD / MI' == old('last_education', $user->last_education) ? 'selected="selected"' : '' }}>SD / MI</option>
                                <option value="SMP / MTS" {{ 'SMP / MTS' == old('last_education', $user->last_education) ? 'selected="selected"' : '' }}>SMP / MTS</option>
                                <option value="SMA / MA" {{ 'SMA / MA' == old('last_education', $user->last_education) ? 'selected="selected"' : '' }}>SMA / MA</option>
                                <option value="SMK / MK" {{ 'SMK / MK' == old('last_education', $user->last_education) ? 'selected="selected"' : '' }}>SMK / MK</option>
                                <option value="Diploma" {{ 'Diploma' == old('last_education', $user->last_education) ? 'selected="selected"' : '' }}>Diploma</option>
                                <option value="S1" {{ 'S1' == old('last_education', $user->last_education) ? 'selected="selected"' : '' }}>S1</option>
                                <option value="S2" {{ 'S2' == old('last_education', $user->last_education) ? 'selected="selected"' : '' }}>S2</option>
                                <option value="S3" {{ 'S3' == old('last_education', $user->last_education) ? 'selected="selected"' : '' }}>S3</option>
                            </select>
