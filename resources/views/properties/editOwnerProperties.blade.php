...
@section('container')
    <form class="tf-form" action="{{ url('/properties/owner/update/'.$property->id) }}" enctype="multipart/form-data" method="POST">
        @method('PUT')
                        ...
                        <div class="card" style="border-radius: 10px; border: 1px solid #acacac; font-size: 14px;">
                            <div class="card-body">
                                ...
                                <div class="group-input">
                                    ...
                                    <input type="text" class="@error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $property->name) }}">
                                    @error('name')
                                ...
                                <div class="group-input">
                                    ...
                                    <select style="width: 100%" name="category" id="category" class="@error('category') is-invalid @enderror select2" data-live-search="true">
                                        ...
                                        <option value="Kos Putra" {{ 'Kos Putra' == old('category', $property->category) ? 'selected="selected"' : '' }}>Kos Putra</option>
                                        <option value="Kos Putri" {{ 'Kos Putri' == old('category', $property->category) ? 'selected="selected"' : '' }}>Kos Putri</option>
                                        <option value="Kos Campur" {{ 'Kos Campur' == old('category', $property->category) ? 'selected="selected"' : '' }}>Kos Campur</option>
                                        <option value="Kontrakan" {{ 'Kontrakan' == old('category', $property->category) ? 'selected="selected"' : '' }}>Kontrakan</option>
                                    </select>
                                    @error('rt')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                ...
                                <div class="group-input">
                                    ...
                                    <textarea name="description" id="description" class="@error('description') is-invalid @enderror" cols="30" rows="5" style="resize: vertical;" onblur="this.style.boxShadow='none'" placeholder="Ceritakan hal yang menarik tentang Kos Anda">{{ old('description', $property->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="group-input">
                                    ...
                                    <input type="text" class="@error('admin_name') is-invalid @enderror" id="admin_name" name="admin_name" value="{{ old('admin_name', $property->user->name ?? '') }}">
                                    @error('admin_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="group-input">
                                    ...
                                    <input type="number" class="@error('admin_number') is-invalid @enderror" id="admin_number" name="admin_number" value="{{ old('admin_number', $property->user->phone_number ?? '') }}">
                                    @error('admin_number')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    @foreach ($facilities as $facility)
                                        <div class="col-6">
                                            <div class="form-check">
                                                <input type="checkbox" name="facility_id[]" {{ (is_array(old('facility_id', $facilitiy_id)) && in_array($facility->id, old('facility_id', $facilitiy_id))) ? 'checked' : '' }} class="form-check-input facility_id" id="facility_id_{{ $facility->id }}" value="{{ $facility->id }}">
                        ...
                        <div class="card" style="border-radius: 10px; border: 1px solid #acacac; font-size: 14px;">
                            <div class="card-body">
                                ...
                                @foreach ($regulations as $regulation)
                                    <div class="form-check">
                                        <input type="checkbox" name="regulation_id[]" {{ (is_array(old('regulation_id', $regulation_id)) && in_array($regulation->id, old('regulation_id', $regulation_id))) ? 'checked' : '' }} class="form-check-input regulation_id" id="regulation_id_{{ $regulation->id }}" value="{{ $regulation->id }}">
                                ...
                                <div class="group-input">
                                    <div class="file-input-wrapper">
                                        ...
                                        <div class="file-name-display">
                                            <span class="room_display">{{ $property->regulation_file_name ? basename($property->regulation_file_name) : 'Belum ada file dipilih' }}</span>
                                        </div>
                                    </div>
                                    ...
                                    @if ($property->regulation_file_path)
                                        <div class="image-preview-container mt-2">
                                            <a href="{{ url('/storage/'.$property->regulation_file_path) }}">
                                                <img src="{{ asset('storage/'.$property->regulation_file_path) }}" alt="Preview Foto" style="max-width: 200px; max-height: 200px;">
                                            </a>
                                        </div>
                                    @endif
                                </div>
                        ...
                        <div class="card" style="border-radius: 10px; border: 1px solid #acacac; font-size: 14px;">
                            <div class="card-body">
                                ...
                                <div class="group-input">
                                    ...
                                    <textarea name="address" id="address" class="@error('address') is-invalid @enderror" cols="30" rows="5" style="resize: vertical;" onblur="this.style.boxShadow='none'" placeholder="Cari alamat">{{ old('address', $property->address) }}</textarea>
                                ...
                                <div class="group-input">
                                    ...
                                    <select style="width: 100%" name="province_id" id="province_id" class="select2 @error('province_id') is-invalid @enderror">
                                        ...
                                        @foreach ($provinces as $province)
                                            <option value="{{ $province->id }}" {{ $province->id == old('province_id', $property->province_id) ? 'selected="selected"' : '' }}>{{ $province->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('province_id')
                                    <div class="invalid-feedback">
                                ...
                                <div class="group-input">
                                    ...
                                    <select style="width: 100%" name="city_id" id="city_id" class="select2 @error('city_id') is-invalid @enderror">
                                        ...
                                        @foreach ($cities as $city)
                                            <option value="{{ $city->id }}" {{ $city->id == old('city_id', $property->city_id) ? 'selected="selected"' : '' }}>{{ $city->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('city_id')
                                    <div class="invalid-feedback">
                                ...
                                <div class="group-input">
                                    ...
                                    <select style="width: 100%" name="district_id" id="district_id" class="select2 @error('district_id') is-invalid @enderror">
                                        ...
                                        @foreach ($districts as $district)
                                            <option value="{{ $district->id }}" {{ $district->id == old('district_id', $property->district_id) ? 'selected="selected"' : '' }}>{{ $district->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('district_id')
                                    <div class="invalid-feedback">
                                ...
                                <div class="group-input">
                                    ...
                                    <select style="width: 100%" name="village_id" id="village_id" class="select2 @error('village_id') is-invalid @enderror">
                                        ...
                                        @foreach ($villages as $village)
                                            <option value="{{ $village->id }}" {{ $village->id == old('village_id', $property->village_id) ? 'selected="selected"' : '' }}>{{ $village->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('village_id')
                                    <div class="invalid-feedback">
                                ...
                                <div class="row" style="display: none;">
                                    <div class="col-6">
                                        <div class="group-input">
                                            ...
                                            <input type="text" id="latitude" name="latitude" class="@error('latitude') is-invalid @enderror" value="{{ old('latitude', $property->latitude) }}" readonly>
                                            @error('latitude')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-6">
                                        <div class="group-input">
                                            ...
                                            <input type="text" id="longitude" name="longitude" class="@error('longitude') is-invalid @enderror" value="{{ old('longitude', $property->longitude) }}" readonly>
                                            @error('longitude')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                            ...
                            <div class="card-body">
                                    ...
                                    @if(count($property->photos) > 0)
                                        @foreach($property->photos as $key => $photo)
                                            <div class="propertyItem">
                                                <label for="property_file_path">Foto {{ $key + 1 }}</label>
                                                <div class="group-input">
                                                    <div class="row">
                                                        <div class="col-10">
                                                            <div class="file-input-wrapper">
                                                                <input class="form-control" type="file" name="property_file_path[]" accept="image/*">
                                                                <div class="file-name-display">
                                                                    <span class="current-file">{{ $photo->property_file_name ? basename($photo->property_file_name) : 'Belum ada file dipilih' }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="image-preview mt-2">
                                                                <a href="{{ url('/storage/'.$photo->property_file_path) }}">
                                                                    <img src="{{ asset('storage/'.$photo->property_file_path) }}" alt="Preview Foto" style="max-width: 200px; max-height: 200px;">
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="col-2">
                                                        ...
                                                        <input type="hidden" name="old_property_file_path[]" value="{{ $photo->property_file_path }}">
                                                        <input type="hidden" name="old_property_file_name[]" value="{{ $photo->property_file_name }}">
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                ...
                                <div class="group-input">
                                    <div class="file-input-wrapper">
                                        ...
                                        <div class="file-name-display">
                                            <span class="video_file_name">{{ $property->video_file_name ? basename($property->video_file_name) : 'Belum ada file dipilih' }}</span>
                                        </div>
                                ...
                                <div class="video-preview">
                                    ...
                                    <video id="videoPlayer" src="{{ url('/storage/'.$property->video_file_path) }}" autoplay controls style="display: {{ $property->video_file_path ? 'block' : 'none' }}">
                                        Browser Anda tidak mendukung pemutaran video.
                                    </video>
                                    <p id="noVideoText" style="margin-top: 15px; display: {{ $property->video_file_path ? 'none' : 'block' }}">
                                        Silakan pilih file video untuk melihat pratinjau
                                    </p>
                                </div>
    ...
    @push('script')
        <script>
            ...
            function initMap(lat = -6.2088, lng = 106.8456) {
                ...
                .bindPopup($('#address').val() ? $('#address').val() : "Lokasi terpilih")
                .openPopup();
