...
@section('container')
    ...
    <div class="bottom-navigation-bar st2 bottom-btn-fixed" style="bottom:65px">
        <div class="tf-container">
            <a class="tf-btn small" style="color: green; border:1px solid green; background-color:white;" href="{{ url('/properties/user/rent/'.$property->id.'?room_id='.$room->id) }}">Sewa Kos Ini</a>
        </div>
    </div>
